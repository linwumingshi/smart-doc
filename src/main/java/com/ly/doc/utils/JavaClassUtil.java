...
public class JavaClassUtil {
	...
	public static Object getEnumValue(JavaClass javaClass, ProjectDocConfigBuilder builder, boolean formDataEnum) {
		...
		// Try getting value from method with JsonValue or JsonCreator annotation
		String methodName = findMethodWithJsonValueOrJsonCreator(javaClass);
	...
	/**
	 * Finds the method in the class that has a specified annotation.
	 * @param javaClass The JavaClass to search in
	 * @return The method name if found, null otherwise
	 */
	private static String findMethodWithJsonValueOrJsonCreator(JavaClass javaClass) {
		for (JavaMethod method : javaClass.getMethods()) {
			for (JavaAnnotation annotation : method.getAnnotations()) {
				...
				// Handle JsonCreator annotation
				if (DocAnnotationConstants.JSON_CREATOR.equals(annotationName)) {
					return method.getName();
				}
			}
		}
	...
	/**
	 * Finds the field in the class that has a specified annotation.
	 * @param javaClass The JavaClass to search in
